    ...
    if (pFile != NULL)
    {
        while (fscanf(pFile, "%d ", &codigo) != EOF)
        {
            ...
            if (inicio->codigo == codigoC)
            {
                ...
                {
                    inicio->quantidadeEstoque -= quantidadeC;
...
void editarCarrinho()
{
    ...
    while (produto != NULL)
    {
        if (produto->codigo == codigoC)
        {
            ...
            if (novaQuantidade <= inicio->quantidadeEstoque)
            {
                carrinhoCompra.quantidade += (novaQuantidade - produto->quantidadeEstoque);
...
void efetuarCompra()
{
    ...
    if (pFile != NULL)
    {
        ...
        {
            struct Produto *produto = carrinhoCompra.produtos;
            struct Produto *produtoAnterior = NULL;
            ...
            while (produto != NULL)
            {
                ...
                // Use uma variável para rastrear se o produto foi encontrado no arquivo
                ...
                // Verifique se o produto foi encontrado no arquivo
                if (produtoEncontrado)
                {
                    // Calcule o valor total da compra
                    totalCompra += (produto->quantidadeEstoque * produto->precoUnitario);
                }
                else
                {
                    printf("Produto não encontrado no arquivo de estoque.\n");
                }
